...
channel.queue_bind(exchange='donbot', queue=queue_name, routing_key="traducir")
...
print(' donbot_Translate_Es_En Waiting for messages...')
...
def callback(ch, method, properties, body):
    ...
    if query.startswith("[traducir]") and len(str(body))<300:
        ...
        channel.basic_publish(exchange='donbot', routing_key="publicar_slack", body="traducción es->en:"+str(result[0]))
