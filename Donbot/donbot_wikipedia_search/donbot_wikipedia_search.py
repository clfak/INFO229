...
channel.queue_bind(exchange='donbot', queue=queue_name, routing_key="wikipedia")
...
def callback(ch, method, properties, body):
    ...
    if str(body).startswith("b'[wikipedia]"):
        ...
        channel.basic_publish(exchange='donbot', routing_key="publicar_slack", body=query+":"+result)
